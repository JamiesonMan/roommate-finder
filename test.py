...
class TestRoommatePreferences(unittest.TestCase):
    ...
    def setUp(self):
        self.user1 = roommatePreferences(quiet_score=3, location_status='southside', location_score=2, dorm_status='stephenson', dorm_score=3,
            animal_status='yes', animal_score=4, visitor_status='no', cleanliness_score=2, 
            bed_time=datetime(22, 0), drinking_status='no', smoking_status='no', smoking_score=3,
            drinking_score=2, visitor_score=1, bedtime_score=4, allergy_status='yes', allergy_score='yes')
        
        self.user2 = roommatePreferences(quiet_score=4, location_status='southside', location_score=2, dorm_status='stephenson', dorm_score=2,
            animal_status='no', animal_score=1, visitor_status='yes', cleanliness_score=3, 
            bed_time=datetime(23, 0), drinking_status='yes', smoking_status='yes', smoking_score=5,
    ...
    def test_compute_compatibility(self):
        self.assertEqual((self.user1.compute_compatability(self.user2)), 82)
